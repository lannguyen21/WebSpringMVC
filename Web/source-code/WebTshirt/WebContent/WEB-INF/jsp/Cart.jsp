...
<body>
    ...
    <!--=================================Header==================================-->
      <div id="navbar">
        ...
        <ul class="nav-link">
          ...
          <li class="nav-item"><a href="#"><i class="fa fa-opencart"></i></a></li>
  ...
  <div id="content">
    ...
    <div id="cart-container" style="margin-bottom: 250px">
        <div id="cart-header">
        ...
        <div class="product-container">
          ...
          <div class="wrap-product">
            <div class="product">
              ...
              <div class="remove">
                <button type="button" name="button"><i class="fa fa-times"></i></button>
              </div>
            </div>
          </div>
